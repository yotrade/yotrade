...
function Row({ tournament, now }: { tournament: IndexedTournament; now: bigint }) {
  ...
  return (
    <Link
      ...
      className="block rounded-3xl focus-visible:outline-2 focus-visible:outline-accent"
    >
      <Card className="flex flex-col gap-2 transition hover:border-accent">
        ...
        <div className="flex items-baseline gap-2">
          <Amount value={tournament.prizePool} />
          <span className="text-sm font-medium text-ink-muted">prize pool</span>
        </div>
